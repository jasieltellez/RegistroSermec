...
<div>
	<h3 class="text-center">Editar Orden de Servicio</h3>
</div>
...
<form id="frmNewClient" class="col-md-10">
	...
	<div class="row">
		<div class="form-group col-md-3">
			...
			<input type="date" class="form-control" id="inputDateSO" placeholder="Fecha de Orden" value=<?php echo($order->date_order)?>>
		</div>
		<div class="form-group col-md-3">
			<label for="inputDateIn">Fecha de Entrada</label>
			<input type="date" class="form-control" id="inputDateIn" placeholder="Fecha de Entrada" value=<?php echo($order->date_in)?>>
		</div>
		<div class="form-group col-md-3">
			<label for="inputDateOut">Fecha de Salida</label>
			<input type="date" class="form-control" id="inputDateOut" placeholder="Fecha de Salida" value=<?php echo($order->date_out)?>>
		</div>
		<div class="form-group col-md-3">
			<label for="inputKms">Cuenta Millas</label>
			<input type="text" class="form-control" id="inputKms" placeholder="Distancia en Km" value=<?php echo($order->kms)?>>
		</div>
	</div>
	...
	<div class="row">
		<div class="form-group col-md-3">
			...
			<select class="form-control" id="selectClientName" value=<?php echo($order->Client_id)?>>
	...
	<div class="row">
		<div class="form-group col-md-3">
			...
			<select class="form-control" id="selectPatent" value=<?php echo($order->Vehicle_id)?>>
				<option value="Seleccione">Seleccione</option>
				<?php echo($vehicles)?>
			</select>
		</div>
	...
	<div class="row">
		...
		<div class="form-group col ">
			...
			<textarea id="inputObservaciones" class="form-control"><?php echo($order->notes)?></textarea>
		</div>
				...
				<tbody id="tbodyTotales">
					...
					<tr>
						...
						<td><div class="input-group">
							...
							<input type="text" class="form-control text-right" id="inputValorT" readonly value=<?php echo($order->total)?>>
							<div class="input-group-append">
					...
					<tr>
						...
						<td><div class="input-group">
							...
							<input type="text" class="form-control text-right" id="inputValorDescuento" required value=<?php echo($order->discount)?>>
							<div class="input-group-append">
								<span class="input-group-text " >.00</span>
							</div>
						</div></td>
					...
					<tr>
						...
						<td><div class="input-group">
							...
							<input type="text" class="form-control text-right" id="inputValorAbono" required value=<?php echo($order->deposit)?>>
							<div class="input-group-append">
								<span class="input-group-text " >.00</span>
							</div>
						</div></td>
					...
					<tr>
						...
						<td><div class="input-group">
							...
							<input type="text" class="form-control text-right" id="inputSaldo" readonly value=<?php echo($order->balance)?>>
							<div class="input-group-append">
								<span class="input-group-text " >.00</span>
							</div>
						</div></td>
					...
					<tr>
						...
						<td>
							...
							<div class="input-group">
								...
								<select class="form-control text-center" id="selectPayment" value=<?php echo($order->payment_method)?>>
